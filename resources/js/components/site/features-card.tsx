...
export function FeaturesCards() {
    ...
    const features = mockdata.map((feature) => (
        <Card key={feature.title} shadow="md" radius="md" className="border-1 border-blue-100" padding="xl">
    ...
    return (
        <Container className="!z-10" size="lg" py="xl">
            ...
            <Text c="dimmed" className="!mx-auto !max-w-2xl" ta="center" mt="md">
