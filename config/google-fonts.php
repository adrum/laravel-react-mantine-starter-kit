...
return [
     ...
     */
    'fonts' => [
        'primary' => 'https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,699;1,699&family=Outfit:wght@100..900&display=swap',
        'secondary' => 'https://fonts.googleapis.com/css2?family=Ancizar+Sans:ital,wght@0,100..1000;1,100..1000&family=Open+Sans:ital,wght@0,699;1,699&family=Outfit:wght@100..900&display=swap',
    ],
